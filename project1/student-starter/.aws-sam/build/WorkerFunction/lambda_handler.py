...
def compute_score(bid, opportunity):
    ...
    device = opportunity["device_type"]
    timestamp = opportunity["timestamp"]

    # relevance multiplier
    relevance = 1.0
    if content_category == "sports" and category == "sportswear":
        relevance = 1.4
    elif content_category == "sports" and category == "energy_drink":
        relevance = 1.3
    elif content_category == "finance" and category == "fintech":
        relevance = 1.5
    elif content_category == "entertainment" and category == "streaming":
        relevance = 1.4
    elif content_category == "lifestyle" and category == "beauty":
        relevance = 1.3

    # device bonus
    device_bonus = 1.1 if device == "mobile" else 1.0
    ...
    score = bid_amount * relevance * device_bonus * time_bonus
    return score
